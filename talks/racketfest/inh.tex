...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag1.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag2.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag3.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag4.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag5.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag6.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag7.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag8.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag9.png}
      };
    \end{tikzpicture}
  \end{frame}
}
...
{ % all template changes are local to this group.
  ...
  \begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
      \node[at=(current page.center)] {
        \includegraphics[height=\paperheight]{classdiag-full.png}
      };
    \end{tikzpicture}
  \end{frame}
}
